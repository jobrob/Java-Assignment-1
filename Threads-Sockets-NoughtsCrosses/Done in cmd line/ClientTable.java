...
public class ClientTable {
  ...
  private ConcurrentMap<String,MoveQueue> queueTable  = new ConcurrentHashMap<String,MoveQueue>();
  ...
  public void add(String nickname) {
    queueTable.put(nickname, new MoveQueue());
  }

  // Returns null if the nickname is not in the table:
  public MoveQueue getQueue(String nickname) {
